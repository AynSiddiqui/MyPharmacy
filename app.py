...
from modelg import searching11g, sideeffectsg, drugconditiong, drugratingg
...
def searchgen():
    ...
    return render_template("index2.html",len=len(med), med=med, condition=condition, rating=rating, side=side)
    #return k
